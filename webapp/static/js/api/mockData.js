...
export const MOCK_PREDICTION_NOW = {
  ...
  stations: [
    { station_id: 'BikePoints_392', station_name: 'Imperial College, Knightsbridge',          predicted_empty_docks: 0,  available_bikes: 8,  confidence: 0.95, walk_to_destination_min: 1,  preference_rank: 1,  is_recommended: false, status: 'likely_full' },
    { station_id: 'BikePoints_356', station_name: 'Prince Consort Road, Knightsbridge',       predicted_empty_docks: 1,  available_bikes: 12, confidence: 0.62, walk_to_destination_min: 2,  preference_rank: 2,  is_recommended: false, status: 'low' },
    { station_id: 'BikePoints_428', station_name: 'Exhibition Road, Knightsbridge',            predicted_empty_docks: 7,  available_bikes: 10, confidence: 0.89, walk_to_destination_min: 5,  preference_rank: 3,  is_recommended: true,  status: 'good' },
    { station_id: 'BikePoints_809', station_name: 'Exhibition Road Museums 1, South Kensington', predicted_empty_docks: 4, available_bikes: 14, confidence: 0.84, walk_to_destination_min: 5, preference_rank: 4, is_recommended: false, status: 'moderate' },
    { station_id: 'BikePoints_810', station_name: 'Exhibition Road Museums 2, South Kensington', predicted_empty_docks: 3, available_bikes: 6, confidence: 0.81, walk_to_destination_min: 6, preference_rank: 5, is_recommended: false, status: 'moderate' },
    { station_id: 'BikePoints_191', station_name: 'Victoria & Albert Museum, Cromwell Road',   predicted_empty_docks: 12, available_bikes: 22, confidence: 0.91, walk_to_destination_min: 6,  preference_rank: 6,  is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_216', station_name: 'South Kensington Station, South Kensington', predicted_empty_docks: 8, available_bikes: 28, confidence: 0.88, walk_to_destination_min: 8, preference_rank: 7, is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_160', station_name: 'Holy Trinity Brompton, Knightsbridge',     predicted_empty_docks: 5,  available_bikes: 15, confidence: 0.79, walk_to_destination_min: 9,  preference_rank: 8,  is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_150', station_name: 'Natural History Museum, South Kensington',  predicted_empty_docks: 10, available_bikes: 20, confidence: 0.87, walk_to_destination_min: 7,  preference_rank: 9,  is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_403', station_name: 'Queens Gate, Kensington Gardens',           predicted_empty_docks: 6,  available_bikes: 11, confidence: 0.83, walk_to_destination_min: 7,  preference_rank: 10, is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_187', station_name: 'Queen\'s Gate (South), South Kensington',   predicted_empty_docks: 2,  available_bikes: 9, confidence: 0.71, walk_to_destination_min: 8,  preference_rank: 11, is_recommended: false, status: 'low' },
    { station_id: 'BikePoints_263', station_name: 'Albert Gate, Hyde Park',                    predicted_empty_docks: 14, available_bikes: 18, confidence: 0.90, walk_to_destination_min: 11, preference_rank: 12, is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_400', station_name: 'Palace Gate, Kensington Gardens',           predicted_empty_docks: 5,  available_bikes: 7, confidence: 0.76, walk_to_destination_min: 10, preference_rank: 13, is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_163', station_name: 'Knightsbridge, Hyde Park',                  predicted_empty_docks: 9,  available_bikes: 16, confidence: 0.85, walk_to_destination_min: 10, preference_rank: 14, is_recommended: false, status: 'good' },
    { station_id: 'BikePoints_97',  station_name: 'Cadogan Place, Knightsbridge',              predicted_empty_docks: 7,  available_bikes: 13, confidence: 0.82, walk_to_destination_min: 12, preference_rank: 15, is_recommended: false, status: 'good' },
  ],
};
